...
<CardGroup cols={2}>
  ...
  <Card title="Tools Reference" icon="wrench" href="/mcp/tools/overview">
    Browse all 23 available tools by category
  </Card>

  <Card title="Birdeye Platform" icon="/images/birdeye-favicon.svg" href="https://birdeye.com">
...
- _"What are my review trends over the last 30 days?"_
- _"Which of my locations have the lowest listing accuracy on Google?"_
- _"Show me the SWOT analysis from the latest Search AI run."_
- _"How did my Facebook posts perform last month compared to the month before?"_
