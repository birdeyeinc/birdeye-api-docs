...
<CardGroup cols={2}>
  ...
  <Card title="Business" icon="building" href="/mcp/tools/business/get-business-info">
    Business profile and child location discovery
  </Card>
  <Card title="Surveys" icon="clipboard-list" href="/mcp/tools/surveys/get-all-surveys">
  ...
  <Card title="Social" icon="share-nodes" href="/mcp/tools/social/track-social-post">
    Social performance reports across multiple channels like Instagram, Facebook, LinkedIn etc.
  </Card>
  <Card title="Ticketing" icon="ticket" href="/mcp/tools/ticketing/get-all-ticket-data">
    Ticket retrieval with filtering and pagination
  </Card>
  <Card title="Aggregation" icon="layer-group" href="/mcp/tools/aggregation/get-all-aggregation-sources">
