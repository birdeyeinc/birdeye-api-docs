...
Returns the full list of surveys configured for the authenticated business. Use this to discover survey IDs before fetching responses with [`get_survey_responses`](/mcp/tools/surveys/get-survey-responses).
