...
<CardGroup cols={1}>
  ...
  <Card title="delete_business" icon="trash" href="/mcp/tools/business/delete-business">
    Permanently delete a business, account, or sub-reseller
  </Card>
</CardGroup>
...
- `create_business`, `update_business_status`, and `delete_business` are **write tools** — confirm the exact target and intent before calling. `delete_business` is irreversible.
