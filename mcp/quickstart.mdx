...
<Info>
  Use the **EU endpoint** if your Birdeye account is hosted in the European Union region.
</Info>

Add the appropriate URL for your region to your AI client to get started. Choose your client below.
...
<Tabs>
  <Tab title="Claude (claude.ai)">
    ...
    ```
    <Note>EU accounts: use `https://mcp-eu.birdeye.com/mcp` instead.</Note>

    <img src="/images/quickstart-claude.png" alt="Claude Add custom connector dialog with Birdeye name and MCP URL filled in" />
  ...
  <Tab title="ChatGPT">
    ...
    <img src="/images/quickstart-chatgpt.png" alt="ChatGPT New Plugin dialog with Birdeye name, MCP URL, and OAuth selected" />
  ...
  <Tab title="Other MCP Clients">
    ...
    **Server URL (Global)**: `https://mcp.birdeye.com/mcp`  
    **Server URL (EU)**: `https://mcp-eu.birdeye.com/mcp`  
