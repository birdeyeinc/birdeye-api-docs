...
<CardGroup cols={2}>
  <Card title="Reviews" icon="star" href="/mcp-server/tools/reviews/overview">
    Review trends, rating overviews, and individual review data
  </Card>
  <Card title="Business" icon="building" href="/mcp-server/tools/business/get-business-info">
    Business profile and child location discovery
  </Card>
  <Card title="Surveys" icon="clipboard-list" href="/mcp-server/tools/surveys/get-all-surveys">
    Survey catalog and paginated response data
  </Card>
  <Card title="Listings" icon="map-pin" href="/mcp-server/tools/listings/overview">
    Listing profiles, status reports, insights, and product listings
  </Card>
  <Card title="Search AI" icon="magnifying-glass" href="/mcp-server/tools/search-ai/overview">
    AI engine citations, business visibility, accuracy, and SWOT reports
  </Card>
  <Card title="Social" icon="share-nodes" href="/mcp-server/tools/social/track-social-post">
    Social performance reports across multiple channels like Instagram, Facebook, LinkedIn etc.
  </Card>
  <Card title="Ticketing" icon="ticket" href="/mcp-server/tools/ticketing/get-all-ticket-data">
    Ticket retrieval with filtering and pagination
  </Card>
  <Card title="Aggregation" icon="layer-group" href="/mcp-server/tools/aggregation/get-all-aggregation-sources">
