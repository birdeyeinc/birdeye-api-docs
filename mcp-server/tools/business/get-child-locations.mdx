...
- Call this tool first when using any location-level tool such as [`get_listing`](/mcp-server/tools/listings/get-listing) or [`get_listing_location_status_report`](/mcp-server/tools/listings/get-listing-location-status-report).
