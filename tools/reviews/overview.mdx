...
<CardGroup cols={1}>
  <Card title="review_and_rating_overview" icon="chart-line" href="/tools/reviews/review-and-rating-overview">
    Get aggregated review volume and rating trends over a date range
  </Card>
  <Card title="get_reviews" icon="list" href="/tools/reviews/get-reviews">
    Fetch individual reviews with full detail — rating, comment, reviewer info, source, status
  </Card>
  <Card title="get_review_summary" icon="chart-bar" href="/tools/reviews/get-review-summary">
